...
--
-- Host: mariadb
-- Generation Time: May 13, 2026 at 04:30 AM
...
--
INSERT INTO
    `center_waste_stock` (`waste_type_id`, `stock_weight`, `updated_at`)
VALUES
...
VALUES
    ...
    (1, 4, 0.000, '2026-05-02 15:49:46'),
    (1, 5, 0.000, '2026-05-02 14:21:45'),
    (1, 6, 0.350, '2026-05-02 15:52:58'),
    (1, 7, 0.000, '2026-05-02 14:21:45'),
...
VALUES
    ...
    (
        008,
        'เคมีประยุกต์และการพัฒนาผลิตภัณฑ์',
        '',
        'CHEM',
        001,
        '2026-01-16 09:51:12',
...
VALUES
    (
        ...
        'admin',
        '0816047264',
        '$2y$12$eHf3/jMRxH9BAfjZHN.G8.yozUERW747FNpQkJACrJakx9Zr9PwqC',
        NULL,
        NULL,
        NULL,
        01,
    ...
    (
        ...
        'เปียกปอน',
        '0123456789',
        '$2y$12$V75oElQbotgJ/wJ7i6gTgewN1DRFwDRW8mmVHsNjbq1fPTKcQsmT.',
        NULL,
        001,
        004,
        05,
    ...
    (
        ...
        'user@fe',
        '0567891234',
        '$2y$12$nrQy/iIn.5dvhMW6x4aa3ep5HF7CUuj7cZwvifiMFRCF9jFu1mR7a',
        NULL,
        002,
        005,
        02,
    ...
    (
        ...
        'กิตติ',
        '0678912345',
        '$2y$12$PchGjKE4WfeOEXxng41KfuPWW11ossaoIF/fOfFu9lWiJHxpYWN1y',
        NULL,
        001,
        NULL,
        02,
    ...
    (
        ...
        'ศูนย์ใหญ่',
        '0634122301',
        '$2y$12$ojRsEtSNEO52vpAfsVkdCO7Jf2HaMse.Dh1./s.dAqGC.Ja.wqNjW',
        NULL,
        NULL,
        NULL,
        04,
    ...
    (
        ...
        'จิ๋ว',
        '0789123456',
        '$2y$12$zSGJkg5RXGqkIjo.EJODduSVuV2gkaRQ9olLv3WBX0vPsKMMZX0yG',
        NULL,
        004,
        NULL,
        02,
    ...
    (
        ...
        'เจ้าหน้าที่คณะวิทย์',
        '0912345678',
        '$2y$12$efplvrv7noSANjwrFtRBg.RPKUNPDnFqnmRjPn66lUj35QwQtKI22',
        NULL,
        001,
        NULL,
        03,
    ...
    (
        ...
        'ภูมิศักดิ์',
        '0234567891',
        '$2y$12$hRwAXnBqAyG400lihC8Im.3xd3pBcSjhQdT/28/kSbmvCLukcPkee',
        NULL,
        001,
        007,
        02,
    ...
    (
        ...
        'BRU Go Green Admin',
        '06142514',
        '$2y$12$.OzR5xLPatJOEDcaQ6HUg.tef/9w.Z8xWfZMUPFECr7xbG9FXwEIy',
        NULL,
        NULL,
        NULL,
        01,
    ...
    (
        ...
        '0800599986',
        '$2y$12$GxjciICXU8jOKXDl6jkJpOeBK6egcNhGVO7xC4qGbBJPPFGayxWCy',
        'benz.wp@gmail.com',
        001,
        004,
        02,
    ...
    (
        000078,
        NULL,
        'นักศึกษา มนุษย์ศาสตร์',
        '0222222222',
        '$2y$12$lEJN9oZyIG.gKd//QVHpEe05ssAAqeLBBRCcV0kkG6EOmkbsU81LG',
        NULL,
        006,
        NULL,
        02,
    ...
    (
        000079,
        NULL,
        'นักศึกษา วิทยาการจัดการ',
        '0111111111',
        '$2y$12$uHGEqbuDDquUsHkSPYFVrOtonU6RgmmO6ypDRC5tlVTL6EipyItDm',
        NULL,
        007,
        NULL,
        02,
    ...
    (
        ...
        'นักศึกษา พยาบาล',
        '03333333',
        '$2y$12$q5ZPPFOK.qmWsuSkku295uUEpoY779qGvpjCrh68ZE24tIRxNWDMy',
        NULL,
        008,
        NULL,
        02,
    ...
    (
        ...
        'ภัทรสวันต์ ศรีทัด',
        '0444444444',
        '$2y$12$ZZiP5pOe7uO0mm.QppQuN.bvnIBldwPDvNVVFs.VwxeO0hZTtnB1K',
        'ben.wp@gmail.com',
        001,
        004,
        02,
    ...
    (
        ...
        'admin@sci',
        '1212312121',
        '$2y$12$gP1YwyaRo1LQTAlqvLuIeerb.TtHGWACVirRFns0J/k2Ec0.Mx4b2',
        'admin.sci@gogreen.com',
        001,
        NULL,
        01,
        0,
    ...
    (
        ...
        'วรินทร์พิพัชร  วัชรพงษ์เกษม',
        '080059997',
        '$2y$12$SclSJCoYMk8bzwQYlyNVV.Xqwx7d03tGx9QuEKk4O/f3JIKnaPxra',
        'benz.wp7@gmail.com',
        001,
        004,
        05,
    ...
    (
        ...
        'อาจารย์เบนซ์ ทดสอบ',
        '080059988',
        '$2y$12$YBlDJpnHPnJiwvLwKNX7Zu1N5pFZLWorZteFZydvckGyB73N1Ovoe',
        'benz.wp8@gmail.com',
        NULL,
        NULL,
        06,
    ...
    (
        000099,
        NULL,
        'ทดสอบ benz 0800599988',
        '0800599988',
        '$2y$12$68EtBTgqjg8VrigRrelvBe/nhdBpM.Taq9tiSHWlYdZKSopkTaxiK',
        '0800599988@gmail.com',
        NULL,
        NULL,
        06,
        10,
    ...
    (
        000100,
        NULL,
        'ทดสอบ อสมัครสมาชิกอาจารย์',
        '0112233445',
        '$2y$12$spzOKMHxuhDo0qDuwIb2veMx8S35YH5D6Gnup5/DckxAVlGy6/Slq',
        NULL,
        007,
        NULL,
        05,
...
--
INSERT INTO
    `role` (`role_id`, `role_name`, `role_name_th`)
VALUES
...
INSERT INTO
    `waste_transaction` (
        ...
        `faculty_id`,
        `staff_id`,
        `waste_transaction_total_weight`,
        `waste_transaction_total_point`,
        `waste_transaction_total_co2e`,
        `waste_transaction_note`,
        `created_at`
    )
VALUES
    (
...
INSERT INTO
    `waste_transaction_detail` (
        `waste_transaction_detail_id`,
        `waste_transaction_id`,
        `waste_category_id`,
        `waste_type_id`,
        `waste_transaction_detail_weight`,
        `waste_transaction_detail_rate`,
        `waste_transaction_detail_point`,
        `waste_transaction_detail_co2e`
    )
VALUES
...
--
ALTER TABLE `center_waste_stock` ADD UNIQUE KEY `waste_type_id` (`waste_type_id`),
ADD KEY `center_waste_stock_type` (`waste_type_id`);

--
-- Indexes for table `donation`
--
ALTER TABLE `donation` ADD PRIMARY KEY (`donation_id`),
ADD KEY `fk_donation_member_id` (`member_id`);

--
-- Indexes for table `donation_detail`
--
ALTER TABLE `donation_detail` ADD PRIMARY KEY (`donation_detail_id`);

--
-- Indexes for table `donation_item`
--
ALTER TABLE `donation_item` ADD PRIMARY KEY (`donation_item_id`),
ADD UNIQUE KEY `donation_detail_name_UNIQUE` (`donation_item_name`);

--
-- Indexes for table `donation_item_category`
--
ALTER TABLE `donation_item_category` ADD PRIMARY KEY (`donation_item_category_id`),
...
--
ALTER TABLE `faculty_waste_stock` ADD PRIMARY KEY (`faculty_id`, `waste_type_id`);
...
--
ALTER TABLE `member_item` ADD PRIMARY KEY (`member_item_id`);
...
--
ALTER TABLE `system_log` ADD PRIMARY KEY (`system_log_id`),
ADD KEY `fk_system_log_member_id` (`system_log_member_id`);

--
-- Indexes for table `waste_category`
--
ALTER TABLE `waste_category` ADD PRIMARY KEY (`waste_category_id`),
ADD UNIQUE KEY `waste_category_name_UNIQUE` (`waste_category_name`);

--
-- Indexes for table `waste_clearance`
--
ALTER TABLE `waste_clearance` ADD PRIMARY KEY (`waste_clearance_id`),
ADD KEY `fk_waste_clearance_faculty` (`faculty_id`);

--
-- Indexes for table `waste_clearance_detail`
--
ALTER TABLE `waste_clearance_detail` ADD PRIMARY KEY (`waste_clearance_detail_id`);

--
-- Indexes for table `waste_sale`
--
ALTER TABLE `waste_sale` ADD PRIMARY KEY (`waste_sale_id`);

--
-- Indexes for table `waste_sale_detail`
--
ALTER TABLE `waste_sale_detail` ADD PRIMARY KEY (`waste_sale_detail_id`);

--
-- Indexes for table `waste_transaction`
--
ALTER TABLE `waste_transaction` ADD PRIMARY KEY (`waste_transaction_id`),
...
--
ALTER TABLE `waste_transaction_detail` ADD PRIMARY KEY (`waste_transaction_detail_id`),
...
--
ALTER TABLE `waste_type` ADD PRIMARY KEY (`waste_type_id`),
...
--
ALTER TABLE `donation_detail` MODIFY `donation_detail_id` int (6) UNSIGNED ZEROFILL NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `donation_item`
--
ALTER TABLE `donation_item` MODIFY `donation_item_id` int (3) UNSIGNED ZEROFILL NOT NULL AUTO_INCREMENT,
AUTO_INCREMENT = 13;

--
-- AUTO_INCREMENT for table `donation_item_category`
--
ALTER TABLE `donation_item_category` MODIFY `donation_item_category_id` int (3) UNSIGNED ZEROFILL NOT NULL AUTO_INCREMENT,
AUTO_INCREMENT = 8;

--
-- AUTO_INCREMENT for table `faculty`
--
ALTER TABLE `faculty` MODIFY `faculty_id` int (3) UNSIGNED ZEROFILL NOT NULL AUTO_INCREMENT,
AUTO_INCREMENT = 22;

--
-- AUTO_INCREMENT for table `major`
--
ALTER TABLE `major` MODIFY `major_id` int (3) UNSIGNED ZEROFILL NOT NULL AUTO_INCREMENT,
AUTO_INCREMENT = 53;

--
-- AUTO_INCREMENT for table `member`
--
ALTER TABLE `member` MODIFY `member_id` int (6) UNSIGNED ZEROFILL NOT NULL AUTO_INCREMENT,
AUTO_INCREMENT = 101;

--
-- AUTO_INCREMENT for table `member_item`
--
ALTER TABLE `member_item` MODIFY `member_item_id` int (6) UNSIGNED ZEROFILL NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `role`
--
ALTER TABLE `role` MODIFY `role_id` int (2) UNSIGNED ZEROFILL NOT NULL AUTO_INCREMENT,
AUTO_INCREMENT = 7;
...
--
ALTER TABLE `waste_category` MODIFY `waste_category_id` int (3) UNSIGNED ZEROFILL NOT NULL AUTO_INCREMENT,
AUTO_INCREMENT = 13;

--
-- AUTO_INCREMENT for table `waste_clearance`
--
ALTER TABLE `waste_clearance` MODIFY `waste_clearance_id` int (6) UNSIGNED ZEROFILL NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `waste_clearance_detail`
--
ALTER TABLE `waste_clearance_detail` MODIFY `waste_clearance_detail_id` int (6) UNSIGNED ZEROFILL NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `waste_sale_detail` MODIFY `waste_sale_detail_id` int (6) UNSIGNED ZEROFILL NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `waste_transaction`
--
ALTER TABLE `waste_transaction` MODIFY `waste_transaction_id` int (6) UNSIGNED ZEROFILL NOT NULL AUTO_INCREMENT,
AUTO_INCREMENT = 2;

--
-- AUTO_INCREMENT for table `waste_transaction_detail`
--
ALTER TABLE `waste_transaction_detail` MODIFY `waste_transaction_detail_id` int (6) UNSIGNED ZEROFILL NOT NULL AUTO_INCREMENT,
AUTO_INCREMENT = 5;

--
-- AUTO_INCREMENT for table `waste_type`
--
ALTER TABLE `waste_type` MODIFY `waste_type_id` int (3) UNSIGNED ZEROFILL NOT NULL AUTO_INCREMENT,
AUTO_INCREMENT = 12;
...
--
ALTER TABLE `major` ADD CONSTRAINT `1` FOREIGN KEY (`faculty_id`) REFERENCES `faculty` (`faculty_id`) ON UPDATE CASCADE;

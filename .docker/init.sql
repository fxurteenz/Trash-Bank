...
--
-- Host: database
-- Generation Time: Jul 02, 2026 at 02:18 PM
...
(000009, 000352, 000001, 25.00, 250, NULL, '2026-07-02 11:57:56'),
(000010, 000355, 000001, 20.00, 200, NULL, '2026-07-02 12:00:34'),
(000011, 000356, 000001, 20.00, 200, NULL, '2026-07-02 12:06:51'),
(000019, 000356, 000001, 20.00, 200, NULL, '2026-07-02 19:23:44');
...
(000011, 000009, 'มาม่า', 5.00, 5, 250),
(000012, 000010, 'มาม่า', 4.00, 5, 200),
(000013, 000011, 'มาม่า', 5.00, 4, 200),
(000016, 000019, 'เสื้อ', 10.00, 2, 200);
...
(020, 'มาม่า รสหมูสับ', 002, 'item_6a38fc379e07b.png', 70, NULL, 996, 1, '2026-06-22 16:11:19'),
...
(032, 'มาม่า', 001, NULL, 0, NULL, 14, 0, '2026-07-02 12:06:51'),
(035, 'เสื้อ', 001, NULL, 0, NULL, 2, 0, '2026-07-02 19:23:44');
...
(022, 'ศูนย์1', 'C1', NULL, 9700, '2026-05-26 00:55:12', 1),
...
(22, 1, 20.000, '2026-07-02 16:10:01'),
(22, 4, 10.000, '2026-07-02 19:39:08'),
...
(000352, NULL, 'ทดสอบ บวกแต้มauto', '0999999999', '$2y$12$aeMakUvsQvxQhJnSvbKmdOSgTItVCg1cZb0tSqh5ddh5gc7SHs0bq', NULL, 004, 026, 01, '2026-07-02 18:29:58', NULL),
(000355, NULL, 'ทดสอบ บวกแต้ม', '0888888888', '$2y$12$.3kXgg2m.Fxwrsmp9TmpQOUsyRFAmA9ybORy1GHx.UA8Hxm/8pIXe', NULL, 006, 045, 01, '2026-07-02 18:59:47', NULL),
(000356, NULL, 'บวกแต้ม ทดสอบ', '0777777777', '$2y$12$vytSj8EYWwuNgwQ9U6r.x.PQL.0RL6JfduY/0sWN62NYmSc2rFMY6', NULL, 006, 048, 02, '2026-07-02 19:01:19', NULL);
...
(000008, 1, 352, 20, 1, 70, '2026-07-02 19:40:52');
...
(000172, 0.000, 0.000, 210, 0, 0, 210, 0, 0),
...
(000190, 0.000, 0.000, 200, 0, 1, 200, 0, 1),
...
(000352, 0.000, 0.000, 30, 250, 0, 100, 250, 0),
(000355, 0.000, 0.000, 10, 200, 0, 10, 200, 0),
(000356, 0.000, 0.000, 10, 400, 0, 10, 400, 0);
...
(000003, 000172, 022, NULL, 000001, 20.000, 200, 18.00, NULL, '2026-07-02 16:10:01'),
(000010, 000352, NULL, NULL, NULL, 0.000, 10, NULL, 'แต้มพิเศษสำหรับสมาชิกใหม่', '2026-07-02 11:29:58'),
(000012, 000355, NULL, NULL, NULL, 0.000, 10, NULL, 'แต้มพิเศษสำหรับสมาชิกใหม่', '2026-07-02 11:59:47'),
(000013, 000356, NULL, NULL, NULL, 0.000, 10, NULL, 'แต้มพิเศษสำหรับสมาชิกใหม่', '2026-07-02 12:01:19'),
(000014, 000352, 022, NULL, 000001, 10.000, 100, 31.40, NULL, '2026-07-02 19:39:08');
...
(000003, 000003, 003, 001, 20.000, 2.00, 200, 18.00),
(000004, 000014, 003, 004, 10.000, 2.00, 100, 31.40);
...
--
ALTER TABLE `donation`
  MODIFY `donation_id` int(6) UNSIGNED ZEROFILL NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=20;

--
-- AUTO_INCREMENT for table `donation_detail`
--
ALTER TABLE `donation_detail`
  MODIFY `donation_detail_id` int(6) UNSIGNED ZEROFILL NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=17;

--
-- AUTO_INCREMENT for table `donation_item`
--
ALTER TABLE `donation_item`
  MODIFY `donation_item_id` int(3) UNSIGNED ZEROFILL NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=36;
...
--
ALTER TABLE `member`
  MODIFY `member_id` int(6) UNSIGNED ZEROFILL NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=357;
...
--
ALTER TABLE `member_item`
  MODIFY `member_item_id` int(6) UNSIGNED ZEROFILL NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
...
--
ALTER TABLE `waste_transaction`
  MODIFY `waste_transaction_id` int(6) UNSIGNED ZEROFILL NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15;

--
-- AUTO_INCREMENT for table `waste_transaction_detail`
--
ALTER TABLE `waste_transaction_detail`
  MODIFY `waste_transaction_detail_id` int(6) UNSIGNED ZEROFILL NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
...
--
ALTER TABLE `member_point`
  ADD CONSTRAINT `fk_member_point_member` FOREIGN KEY (`member_id`) REFERENCES `member` (`member_id`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;

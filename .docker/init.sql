...
VALUES
    (1, 1, 4.00, '2026-01-22 16:34:29'),
    (1, 4, 2.00, '2026-01-22 16:34:29'),
    (1, 5, 4.00, '2026-01-22 16:34:29'),
...
INSERT INTO
    `waste_clearance` (
        ...
        `faculty_id`,
        `center_staff_id`,
        `waste_clearance_total_weight`,
        `waste_clearance_total_point`,
        `waste_clearance_note`,
        `created_at`
    )
VALUES
    (
...
INSERT INTO
    `waste_clearance_detail` (
        `waste_clearance_detail_id`,
        `waste_clearance_id`,
        `waste_category_id`,
        `waste_type_id`,
        `waste_clearance_detail_weight`,
        `waste_clearance_detail_rate`,
        `waste_clearance_detail_point`
    )
VALUES
...
INSERT INTO
    `waste_sale` (
        `waste_sale_id`,
        `waste_sale_total_price`,
        `waste_sale_total_weight`,
        `waste_sale_buyer`,
        `waste_sale_note`,
        `created_by`,
        `created_at`
...
INSERT INTO
    `waste_sale_detail` (
        `waste_sale_detail_id`,
        `waste_sale_id`,
        `waste_type_id`,
        `waste_sale_detail_weight`,
        `waste_sale_detail_price`
    )
VALUES
...
--
ALTER TABLE `member_badge` ADD PRIMARY KEY (`member_badge_id`),
...
--
ALTER TABLE `member_reward` ADD PRIMARY KEY (`member_reward_id`),
...
--
ALTER TABLE `donation_item` MODIFY `donation_item_id` int (6) UNSIGNED ZEROFILL NOT NULL AUTO_INCREMENT,
AUTO_INCREMENT = 3;

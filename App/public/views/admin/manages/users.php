<div class="space-y-4 w-full">
    ...
    <div x-data="UserTable()" x-init="initData()" class="bg-white rounded-lg shadow p-6 overflow-x-auto w-full">
        ...
        <div class="flex justify-between mb-1 text-gray-700 text-xs font-regular">
            <div class="flex justify-end mb-1 text-xs space-x-2">
                <div @click="openCreateDialog" :class="createUserDialogShow && 'bg-teal-300'"
        ...
        <table class="w-full table-fixed border-collapse border border-sky-300 text-sm">
            <thead class="bg-sky-100 text-xs">
                <tr>

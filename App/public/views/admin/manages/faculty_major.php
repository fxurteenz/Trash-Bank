<div class="space-y-4 w-full">
    ...
    <div x-data="FacultyMajor()" x-init="fetchAllFaculty()" class="bg-white rounded-lg shadow p-6">
        ...
        <div class="flex justify-between">
            ...
            <div @click="createFacultyDialogShow = true" :class="createFacultyDialogShow && 'bg-teal-300'"
                ...
                <div class="p-4 rounded space-y-2">
                    ...
                    <div class="flex justify-between">
                        ...
                        <div class="flex justify-between text-xs">
                            <div @click="createMajorDialogShow = true" :class="createMajorDialogShow && 'bg-teal-300'"
                                class="group cursor-pointer flex items-center py-1 px-2 border-2 border-teal-500 rounded-lg cursor-pointer hover:bg-teal-300 space-x-1">
                                <button class="group-hover:rotate-90 duration-300" title="Add New">
                                    <svg class="stroke-teal-500 fill-none group-active:stroke-teal-200 group-active:duration-0 duration-300"
                                ...
                                <div class="">
                                    ...
                                    <div class="relative">
                                        ...
                                        <button
                                            class="absolute end-0 bottom-1/2 translate-y-1/2 py-2.5 px-2 text-sm font-medium text-white bg-blue-700 rounded-r-md border border-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                                            <svg viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg"
                                                aria-hidden="true" class="w-4 h-2">
                                                <path d="m19 19-4-4m0-7A7 7 0 1 1 1 8a7 7 0 0 1 14 0Z" stroke-width="2"
                                                    stroke-linejoin="round" stroke-linecap="round"
                                                    stroke="currentColor"></path>
                                            </svg>
                ...
                <div class="grid grid-1 space-y-2 text-sm">
                    ...
                    <div class="flex items-center justify-between text-sm">
                        ...
                        <input
                            ...
                            type="text" id="create_fac_name" x-model="createFacForm.faculty_name">
                    </div>

                </div>

                <div class="mt-4 text-right">
                    <button @click="submitCreateFaculty"
                        class="px-3 py-1 bg-sky-300 rounded hover:bg-sky-400 cursor-pointer">
                        ยืนยัน
                    </button>
            ...
            <div class="bg-white p-6 rounded-lg shadow-xl w-100">
                ...
                <div class="grid grid-1 space-y-2 text-sm">
                    ...
                    <div class="flex items-center justify-between text-sm">
                        ...
                        <input
                            class="border border-gray-300 rounded p-1 focus:ring-sky-300 focus:ring-3 focus:border-sky-200"
                            type="text" id="create_maj_name" x-model="createMajForm.major_name">
                    </div>

                </div>

                <div class=" mt-4 text-right">
                    <button @click="submitCreateMajor"
                        class="px-3 py-1 bg-sky-300 rounded hover:bg-sky-400 cursor-pointer">
                        ยืนยัน
                    </button>
        ...
        return {
                ...
                try {
                    ...
                    if (confirmed.isConfirmed) {
                        const res = await fetch('/api/faculties', {
                            ...
                            body: JSON.stringify(this.createFacForm)
                        });
                        const result = await res.json();
            ...
            async submitCreateMajor() {
                ...
                try {
                    ...
                    if (confirmed.isConfirmed) {
                        this.createMajForm.faculty_id = this.selectedFaculty.faculty_id;
                        ...
                        const res = await fetch('/api/majors', {
                            ...
                            body: JSON.stringify(this.createMajForm)
                        });
                        const result = await res.json();

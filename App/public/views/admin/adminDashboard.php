<div class="grid grid-cols-1 md:grid-cols-2 gap-4 xl:gap-6 xl:flex xl:justify-center mb-6 xl:mb-8">

    <div class="bg-white rounded-lg shadow p-4 xl:p-6 xl:w-2/8">
        <div class="flex items-center justify-between">
            <div class="w-3/5">
                <p class="text-sm text-gray-600">
                    ปริมาณขยะ
                    <span class="text-[10px] text-gray-600">(เดือนนี้)</span>
                </p>
                <p class="text-xl xl:text-2xl font-bold text-gray-900">1.2K กิโล</p>
            </div>
            <div class="p-3 bg-green-100 text-emerald-500 rounded-full">
    ...
    <div class="bg-white rounded-lg shadow p-4 xl:p-6 xl:w-2/8">
        <div class="flex items-center justify-between">
            <div class="w-3/5">
                ...
                <p class="text-xl xl:text-2xl font-bold text-gray-900">1.2 กิโล</p>
            </div>
            <div class="p-3 bg-sky-100 text-sky-500 rounded-full">
    ...
    <div class="bg-white rounded-lg shadow p-4 xl:p-6 xl:w-2/8">
        <div class="flex items-center justify-between">
            <div class="w-3/5">
                ...
                <p class="text-xl xl:text-2xl font-bold text-gray-900">46 ครั้ง</p>
            </div>
    ...
    <div class="bg-white rounded-lg shadow p-4 xl:p-6 xl:w-2/8">
        <div class="flex items-center justify-between">
            <div class="w-3/5">
                ...
                <p class="text-xl xl:text-2xl font-bold text-gray-900">+25%</p>
            </div>
            <div class="p-3 bg-green-100 text-emerald-500 rounded-full">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
                    <g fill="none" stroke="currentColor" stroke-width="2">
...
<div class="grid grid-cols-1 md:grid-cols-2 gap-4 xl:gap-6 mb-6 xl:mb-8">

    <div class="bg-white xl:col-span-1 rounded-lg shadow p-4 h-[40vh]">
        <canvas class="h-full w-full" id="waste-total"></canvas>
    </div>

    <div class="bg-white xl:col-span-1 rounded-lg shadow p-4 h-[40vh]">
        <canvas class="h-full w-full" id="carbon-total"></canvas>
    </div>

    <div class="bg-white xl:col-span-1 rounded-lg shadow p-4 h-[40vh]">
        <canvas class="h-full w-full" id="waste-by-faculty"></canvas>
    </div>

    <div class="bg-white xl:col-span-1 rounded-lg shadow p-4 h-[40vh]">
        <canvas class="h-full w-full" id="carbon-by-faculty"></canvas>
    </div>

    <div class="bg-white rounded-lg shadow p-4 w-full h-[40vh]">
        <canvas class="h-full w-full" id="waste-by-year"></canvas>
    </div>

    <div class="bg-white rounded-lg shadow p-4 w-full h-[40vh]">
        <canvas class="h-full w-full" id="carbon-by-year"></canvas>
    </div>

</div>

<div class="bg-white rounded-lg shadow p-4 xl:p-6">
    <h3 class="text-lg font-semibold mb-4">รายการล่าสุด</h3>
    <p class="text-gray-600">ใส่ตารางหรือรายการข้อมูลตรงนี้...</p>
</div>
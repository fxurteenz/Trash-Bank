<div x-data="RedeemRewardPOSHandler()" x-init="init()" class="flex flex-col h-[calc(100vh-6rem)] gap-4">
    ...
    <div class="flex-none flex flex-col md:flex-row gap-4">
        <div class="md:w-1/3 flex flex-col justify-between gap-4">
            ...
            <!-- <div class="bg-gradient-to-r from-rose-500 to-rose-600 rounded-xl shadow-lg p-4 text-white">
                <div class="flex items-center justify-between">
                    <p class="text-rose-100 text-xs font-medium uppercase tracking-wider mb-1">แลกออกวันนี้</p>
                    <h2 class="text-3xl font-bold flex items-center gap-2">
                        <span x-text="todayStats.count">0</span>
                        <span class="text-sm font-normal text-rose-100 mt-2">รายการ</span>
                    </h2>
                </div>
            </div> -->
        </div>
            ...
            async saveRedemption() {
                ...
                try {
                    ...
                    if (resData.success) {
                        ...
                        this.setCookie('redeemStats', JSON.stringify({ date: today, count: this.todayStats.count }));

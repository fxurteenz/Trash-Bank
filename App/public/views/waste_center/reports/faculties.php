<div x-data="FacultyReport()" x-init="initData()" class="max-w-7xl mx-auto bg-white p-8">
    <div class="header-container flex flex-col items-center justify-center mb-6 relative">
        <h2 class="text-2xl font-bold mb-2">รายงานรายชื่อคณะ/หน่วยงาน</h2>
    ...
    <div class="mb-4">
        <p class="text-sm font-semibold text-gray-700" x-text="`จำนวนคณะ/หน่วยงานรวม: ${faculties.length} แห่ง`"></p>
    </div>
    ...
    <table class="min-w-full bg-white border border-gray-200">
        <thead class="bg-gray-100">
            <tr>
                ...
                <th class="px-4 py-2 border text-left text-xs font-semibold text-gray-600 uppercase">ชื่อคณะ/หน่วยงาน
                </th>

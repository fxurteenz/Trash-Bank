    ...
    <div class="bg-white md:col-span-3 rounded-lg space-y-2 shadow px-4 py-4">
        ...
        <div class="space-y-2 text-sm">
            <div class="w-full flex justify-between">
                <label class="w-2-6" for="">ชื่อผู้ฝาก</label>
                <input class="w-4/6 px-1 py-1 border border-1 border-gray-300 shadow-xs rounded" type="text" name=""
                    id="">
            </div>
            <div class="w-full flex justify-between">
                <label class="w-2-6" for="">ประเภท</label>
                <input class="w-4/6 px-1 py-1 border border-1 border-gray-300 shadow-xs rounded" type="text" name=""
                    id="">
            </div>
            <div class="w-full flex justify-between">
                <label class="w-2-6" for="">น้ำหนัก</label>
                <input class="w-4/6 px-1 py-1 border border-1 border-gray-300 shadow-xs rounded" type="text" name=""
                    id="">
            </div>
        </div>

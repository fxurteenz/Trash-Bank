...
use App\Model\WasteClearanceModel;
use App\Router\RouterBase;
use App\Utils\Authentication;
use App\Utils\AuthenticationException;
use Exception;

class WasteClearanceController extends RouterBase
{
    private static $Data, $WasteClearanceModel, $QueryString;
    public function __construct()
    {
        ...
        self::$WasteClearanceModel = new WasteClearanceModel();
    }
    ...
    public function Create()
    {
        try {
            ...
            $result = self::$WasteClearanceModel->CreateClearance(self::$Data, $operaterData);

...
class StatisticDataController
{
    ...
    public function GetFacultyStats()
    {
        try {
            header('Content-Type: application/json');
            $result = self::$StatisticDataModel->GetFacultyStats(self::$queryString);
            http_response_code(200);
            echo json_encode([
                'success' => TRUE,
                'data' => $result,
    ...
    public function GetMajorStats()
    {
        try {
            header('Content-Type: application/json');
            $result = self::$StatisticDataModel->GetMajorStats(self::$queryString);
            http_response_code(200);
            echo json_encode([
                'success' => TRUE,
                'data' => $result,
